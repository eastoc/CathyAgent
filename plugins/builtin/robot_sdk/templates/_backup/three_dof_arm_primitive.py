"""Primitive three-DoF arm scaffold kept as a migration backup.

Do not use this as the default workflow. New serial arm templates should use
the kinematics-first pipeline in ``../three_dof_arm.py``.
"""
...
def build_robot_model() -> RobotModel:
    robot = RobotModel("three_dof_arm_primitive")
